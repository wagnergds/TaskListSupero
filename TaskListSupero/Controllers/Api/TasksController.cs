...
namespace TaskListSupero.Controllers.Api
{
    [RoutePrefix("api/tasks")]
    public class TasksController : ApiController
    {
        private ITaskListSuperoRepository _repository;

        public TasksController(ITaskListSuperoRepository repository)
        {
        ...
        public IHttpActionResult PostTask(TaskViewModel viewModel)
        {
            ...
            return BadRequest("Falha no post da tarefa");
        }
